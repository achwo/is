...
% Max Value for each column, row and subsquare on a 9x9 Sudoku is 45
% Set for each Xij with i ins 1..9 and j ins 1..9 a Variable
% Set the Domain


dothis :- time(solve( [[7,_,_,_,4,3,_,_,_],
                        [_,1,_,7,_,_,6,_,_],
                        [_,4,_,_,1,_,_,_,2],
                        [_,_,_,_,_,_,4,1,_],
                        [_,_,7,1,_,9,5,_,_],
